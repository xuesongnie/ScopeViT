...
Support for scopevit, poolformer, deit, resmlp, resnet, swin and convnext
...
Example command:
python cam_image.py --use_cuda --image_path /path/to/image.JPEG --model scopevit_tiny
"""
import argparse
import os
import cv2
...
import models  # register_model for scopevit
import timm
